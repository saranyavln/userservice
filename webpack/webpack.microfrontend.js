    ...
    plugins: [
      new ModuleFederationPlugin({
        ...
        shared: {
          ...
          '@angular/core': { singleton: true, strictVersion: true, requiredVersion: '16.2.3' },
          '@angular/common': { singleton: true, strictVersion: true, requiredVersion: '16.2.3' },
          '@angular/common/http': { singleton: true, strictVersion: true, requiredVersion: '16.2.3' },
          '@angular/router': { singleton: true, strictVersion: true, requiredVersion: '16.2.3' },
          '@angular/forms': { singleton: true, strictVersion: true, requiredVersion: '16.2.3' },
          '@angular/platform-browser': { singleton: true, strictVersion: true, requiredVersion: '16.2.3' },
          ...
          '@fortawesome/fontawesome-svg-core': { singleton: true, strictVersion: true, requiredVersion: '6.4.2' },
          '@fortawesome/free-solid-svg-icons': { singleton: true },
          '@ng-bootstrap/ng-bootstrap': { singleton: true, strictVersion: true, requiredVersion: '15.1.1' },
